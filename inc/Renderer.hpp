...
// gerencia janela overlay, device dx11 e ciclo do imgui
...
// callback de mensagens da janela para o imgui
...
// encapsula inicializacao e render do overlay
class Renderer
{
public:
    HWND hwnd{ nullptr };
    ...
    // cria janela, device e contexto do imgui
    void Init()
    {
    ...
    // inicia frame do imgui e processa mensagens
    void StartRender()
    {
        MSG msg;
    ...
    // finaliza frame do imgui e apresenta no swap chain
    void EndRender()
    {
        ImGui::Render();
    ...
    // libera recursos do imgui e do device
    void Shutdown()
    {
    ...
    // cria dispositivo dx11 e swap chain
    ...
    // cria render target a partir do backbuffer
    ...
    // carrega textura do disco e cria SRV
    ...
    // carrega textura embutida como recurso
