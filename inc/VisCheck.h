...
// limite para dividir folhas da BVH
const size_t LEAF_THRESHOLD{ 4 };

// triangulo por indices de vertices
struct Triangle
{
    int a{ 0 };
    int b{ 0 };
...
// caixa alinhada aos eixos para testes de ray
struct AABB
{
    Vector3 min;
    Vector3 max;
...
// triangulo com vertices expandidos
...
// parser do arquivo de geometria do mapa
class Parser
{
private:
    std::string DataPath;
...
// geometria com meshes de triangulos
class Geometry
{
public:
...
// checagem de visibilidade por raycast na BVH
class VisCheck
{
public:
